...
Write-Host "[wyren] setup.ps1 is deprecated. Use install.ps1 instead." -ForegroundColor Yellow
...
if (-not (Test-Path $installPs1)) {
    Write-Error "install.ps1 not found at $installPs1. Please re-clone the wyren repo."
    exit 1
}
