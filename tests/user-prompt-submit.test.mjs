...
/**
 * Sets up a .relay dir with the new file layout:
 *   .relay/state/ups-state.json   — UPS-owned (last_injected_mtime, last_injected_hash)
 *   .relay/state/watermark.json   — Stop-owned (turns_since_distill etc.)
 *   .relay/state/last-injected-memory.md — UPS snapshot
 *   .relay/memory.md
 */
